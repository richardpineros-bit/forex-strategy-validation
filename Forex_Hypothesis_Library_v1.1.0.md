...
**Version:** v1.1.0
**Companion to:** Forex Strategy Validation Playbook v1.0.2
...
| H3 | Month-end flow | 1 | — | Queued (next) |
...
- **Why it persists / counterparty:** Mechanical, calendar-driven institutional flow. Funds must rebalance to mandate regardless of price — forced, price-insensitive. Closest of the remaining Tier 1 to H1's clean flow story.
- **Evidence:** Month-end fix flows documented over decades; tied to the month's equity/bond moves.
