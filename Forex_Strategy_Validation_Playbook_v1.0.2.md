...
|---|-----------|------|--------------|--------|-------|
| 1 | Session drift | 1 | Gate 1 | Active | Gate 0 PASS (spec saved). Gate 1 rule set being locked. Next: Gate 2 backtest (needs intraday EUR/USD data). |
| 2 | Trend momentum | 1 | Gate 2 | Killed | In-sample t 0.27, PF 1.10, DD−30% vs ret +2.7%. Spec v1.0.0. No rescue. |
| 3 | Month-end flow | 1 | — | Queued | |
| 4 | X-sec momentum | 2 | — | Idea | Needs basket infra |
| 5 | Carry | 2 | — | Idea | Crash-tail caution |
| 6 | London breakout | 2 | — | Idea | Crowded |
| 7 | Liquidity-sweep | 3 | — | Idea | Automation-hard |
| 8 | Round-number | 3 | — | Idea | Use as filter |
| 9 | Vol-compression breakout | 3 | — | Idea | Overfit-prone |
...
```
I'm running a forex strategy through my validation pipeline (playbook v1.0.1).
