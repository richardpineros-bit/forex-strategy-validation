...
| 6 | London breakout | 2 | Gate 0 | Active | Gate 0 conditional PASS. Weakest persistence story: mechanism supports volatility not direction; predator (stop-hunt) counterparty. BLOCKED: no intraday data on box. Decision pending: source hourly majors or kill on feasibility. |
...
```
I'm running a forex strategy through my validation pipeline (playbook v1.0.3).
