...
USAGE:
  python3 oanda_index_pull_v1.0.0.py            # probe + depth only
  python3 oanda_index_pull_v1.0.0.py --pull     # also do the full CSV pull
  python3 oanda_index_pull_v1.0.0.py --pull --from 2005-01-01
